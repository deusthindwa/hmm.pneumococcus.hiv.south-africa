...
phirst.es0 <- data.frame("iid"=c("Child HIV+","Child HIV-","Adult HIV-","Adult HIV+"),"age"=c("Child","Child","Adult","Adult"),"hiv"=c("HIV+","HIV-","HIV-","HIV+"),"artv"=c("No","No","No","No"))
...
phirst.es1 <- data.frame("iid"=c("Child HIV+","Adult HIV+"),"age"=c("Child","Adult"),"hiv"=c("HIV+","HIV+"),"artv"=c("Yes","Yes"))
