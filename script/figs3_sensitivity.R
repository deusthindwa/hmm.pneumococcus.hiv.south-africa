...
phirst.hs <- subset(phirst.fu,select=c(ind_id,year,dys,state,obst,agecat,hiv,tx,ahiv,hhsizecat))
...
p.snstvty <- msm(state~dys,subject=ind_id,data=phirst.hs,
                ...
                covariates=list("1-2"=~agecat+hiv+ahiv+tx+hhsizecat+year),
...
#compute the acquisition probabilities by specific sampling year
p.modela <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Younger child",tx="hhtx", year="2016"),ci="normal",cl=0.95)
p.modelb <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Younger child",tx="hhtx", year="2016"),ci="normal",cl=0.95)
p.modelc <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Older child",tx="hhtx", year="2016"),ci="normal",cl=0.95)
p.modeld <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Older child",tx="hhtx", year="2016"),ci="normal",cl=0.95)
p.modele <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx", year="2016"),ci="normal",cl=0.95)
p.modelf <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx", year="2016"),ci="normal",cl=0.95)

phirst.es0 <- data.frame("iid"=c("Younger child HIV+","Younger child HIV-","Older child HIV+","Older child HIV-","Adult HIV+","Adult HIV-"),
                         "age"=c("Younger child","Younger child","Older child","Older child","Adult","Adult"), 
                         "hiv"=c("HIV+","HIV-","HIV+","HIV-","HIV+","HIV-"),"status"=c("2016","2016","2016","2016","2016","2016"))
...
#--------------------------------------------
p.modela <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Younger child",tx="hhtx", year="2017"),ci="normal",cl=0.95)
p.modelb <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Younger child",tx="hhtx", year="2017"),ci="normal",cl=0.95)
p.modelc <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Older child",tx="hhtx", year="2017"),ci="normal",cl=0.95)
p.modeld <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Older child",tx="hhtx", year="2017"),ci="normal",cl=0.95)
p.modele <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx", year="2017"),ci="normal",cl=0.95)
p.modelf <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx", year="2017"),ci="normal",cl=0.95)

phirst.es1 <- data.frame("iid"=c("Younger child HIV+","Younger child HIV-","Older child HIV+","Older child HIV-","Adult HIV+","Adult HIV-"),
                         "age"=c("Younger child","Younger child","Older child","Older child","Adult","Adult"), 
                         "hiv"=c("HIV+","HIV-","HIV+","HIV-","HIV+","HIV-"),"status"=c("2017","2017","2017","2017","2017","2017"))

phirst.es1$carry.est <- c(p.modela$estimates[1,2],p.modelb$estimates[1,2],p.modelc$estimates[1,2],p.modeld$estimates[1,2],p.modele$estimates[1,2],p.modelf$estimates[1,2])
phirst.es1$Lcarry.est <- c(p.modela$L[1,2],p.modelb$L[1,2],p.modelc$L[1,2],p.modeld$L[1,2],p.modele$L[1,2],p.modelf$L[1,2])
phirst.es1$Ucarry.est <- c(p.modela$U[1,2],p.modelb$U[1,2],p.modelc$U[1,2],p.modeld$U[1,2],p.modele$U[1,2],p.modelf$U[1,2])
#--------------------------------------------
p.modela <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Younger child",tx="hhtx", year="2018"),ci="normal",cl=0.95)
p.modelb <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Younger child",tx="hhtx", year="2018"),ci="normal",cl=0.95)
p.modelc <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Older child",tx="hhtx", year="2018"),ci="normal",cl=0.95)
p.modeld <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Older child",tx="hhtx", year="2018"),ci="normal",cl=0.95)
p.modele <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx", year="2018"),ci="normal",cl=0.95)
p.modelf <- pmatrix.msm(p.snstvty,t=1,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx", year="2018"),ci="normal",cl=0.95)

phirst.es2 <- data.frame("iid"=c("Younger child HIV+","Younger child HIV-","Older child HIV+","Older child HIV-","Adult HIV+","Adult HIV-"),
                         "age"=c("Younger child","Younger child","Older child","Older child","Adult","Adult"), 
                         "hiv"=c("HIV+","HIV-","HIV+","HIV-","HIV+","HIV-"),"status"=c("2018","2018","2018","2018","2018","2018"))
...
B <- ggplot(phirst.es) +
  ...
  theme(axis.text.y=element_text(face="bold",size=10)) + 
  theme(axis.title.x=element_blank(),axis.text.x=element_blank(),axis.ticks.x=element_blank()) + 
  guides(color=guide_legend(title=""),shape=guide_legend(title="Sampling year")) + 
  theme(legend.text=element_text(size=10),legend.position="right",legend.title=element_text(face="bold",size=10))
