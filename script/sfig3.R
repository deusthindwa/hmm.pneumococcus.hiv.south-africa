...
p.modeli <- qmatrix.msm(p.hhsize,covariates=list(hiv="Pos",agecat="Child",tx="hhtx",hhsize="11+"),ci="normal",cl=0.95)
...
phirst.es2 <- data.frame("iid"=c("HIV+ Child","HIV- Child","HIV+ Adult","HIV- Adult"),"age"=c("Child","Child","Adult","Adult"), "hiv"=c("HIV+","HIV-","HIV+","HIV-"),"status"=c("11+","11+","11+","11+"))
...
p.modela <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Child",tx="hhtx",hhsize="<6"),ci="normal",cl=0.95)
p.modelb <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Child",tx="hhtx",hhsize="<6"),ci="normal",cl=0.95)
p.modelc <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx",hhsize="<6"),ci="normal",cl=0.95)
p.modeld <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx",hhsize="<6"),ci="normal",cl=0.95)
phirst.es0 <- data.frame("iid"=c("HIV+ Child","HIV- Child","HIV+ Adult","HIV- Adult"),"age"=c("Child","Child","Adult","Adult"), "hiv"=c("HIV+","HIV-","HIV+","HIV-"),"status"=c("<6","<6","<6","<6"))
phirst.es0$carry.est <- c(p.modela$estimates[1,2],p.modelb$estimates[1,2],p.modelc$estimates[1,2],p.modeld$estimates[1,2])
phirst.es0$Lcarry.est <- c(p.modela$L[1,2],p.modelb$L[1,2],p.modelc$L[1,2],p.modeld$L[1,2])
phirst.es0$Ucarry.est <- c(p.modela$U[1,2],p.modelb$U[1,2],p.modelc$U[1,2],p.modeld$U[1,2])

p.modele <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Child",tx="hhtx",hhsize="6-10"),ci="normal",cl=0.95)
p.modelf <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Child",tx="hhtx",hhsize="6-10"),ci="normal",cl=0.95)
p.modelg <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx",hhsize="6-10"),ci="normal",cl=0.95)
p.modelh <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx",hhsize="6-10"),ci="normal",cl=0.95)
phirst.es1 <- data.frame("iid"=c("HIV+ Child","HIV- Child","HIV+ Adult","HIV- Adult"),"age"=c("Child","Child","Adult","Adult"), "hiv"=c("HIV+","HIV-","HIV+","HIV-"),"status"=c("6-10","6-10","6-10","6-10"))
phirst.es1$carry.est <- c(p.modele$estimates[1,2],p.modelf$estimates[1,2],p.modelg$estimates[1,2],p.modelh$estimates[1,2])
phirst.es1$Lcarry.est <- c(p.modele$L[1,2],p.modelf$L[1,2],p.modelg$L[1,2],p.modelh$L[1,2])
phirst.es1$Ucarry.est <- c(p.modele$U[1,2],p.modelf$U[1,2],p.modelg$U[1,2],p.modelh$U[1,2])

p.modeli <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Child",tx="hhtx",hhsize="11+"),ci="normal",cl=0.95)
p.modelj <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Child",tx="hhtx",hhsize="11+"),ci="normal",cl=0.95)
p.modelk <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Pos",agecat="Adult",tx="hhtx",hhsize="11+"),ci="normal",cl=0.95)
p.modell <- pmatrix.msm(p.hhsize,t=289,covariates=list(hiv="Neg",agecat="Adult",tx="hhtx",hhsize="11+"),ci="normal",cl=0.95)
phirst.es2 <- data.frame("iid"=c("HIV+ Child","HIV- Child","HIV+ Adult","HIV- Adult"),"age"=c("Child","Child","Adult","Adult"), "hiv"=c("HIV+","HIV-","HIV+","HIV-"),"status"=c("11+","11+","11+","11+"))
phirst.es2$carry.est <- c(p.modeli$estimates[1,2],p.modelj$estimates[1,2],p.modelk$estimates[1,2],p.modell$estimates[1,2])
phirst.es2$Lcarry.est <- c(p.modeli$L[1,2],p.modelj$L[1,2],p.modelk$L[1,2],p.modell$L[1,2])
phirst.es2$Ucarry.est <- c(p.modeli$U[1,2],p.modelj$U[1,2],p.modelk$U[1,2],p.modell$U[1,2])
